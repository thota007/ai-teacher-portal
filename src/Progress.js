...
import background from './Progress.png';
...
<br/><br/><br/><br/><br/><br/><br/>
        ...
        <Button onClick={goToProgress} style={{color:'grey', borderColor:"#1e90ff", display: 'flex', height:'50px', width:'300px', margin:'10px', fontWeight:'bold'}} variant='contained' >Group Progress ❗</Button>
